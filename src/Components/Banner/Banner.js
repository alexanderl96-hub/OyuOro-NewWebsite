            ...
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1><span className="txt-rotate" dataPeriod="1100" data-rotate='["Welcome to Afro-Cuban World", "Oyu Oro Dance Company ", "Oyu Oro New York & Cuba" ]'><span className="wrap">{text}</span></span></h1>
                  <p style={{backgroundColor: '#44424299', borderRadius: '30px', width: '750px', minHeigth: '40px', padding: '10px', letterSpacing: '1px', marginLeft: '30%', color: 'white', marginTop: '10px'}}>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
